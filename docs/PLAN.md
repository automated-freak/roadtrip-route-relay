...
**Definition of done**
- [x] A multistop itinerary can be built, reordered, and launched in one tap
- [x] Destination-vs-waypoint distinction is clear and correctly builds the itinerary
- [x] New-route notification is non-intrusive and can be muted
